    ...
    <section className="py-20 bg-gradient-to-br from-white to-primary-50 dark:from-primary-900 dark:to-primary-800 min-h-screen pt-32 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          Take a look at some of the projects I've worked on. They highlight my technical skills, creative thinking, and passion for turning ideas into real, working solutions. Each project is a step forward in my journey as a developer.          </p>
        </motion.div>
